...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ssp_var_get_and_del, 0, 0, 0)
ZEND_ARG_VARIADIC_INFO(0, keys)
ZEND_END_ARG_INFO()
...
static const zend_function_entry ssp_functions[] = {
	...
	PHP_FE(ssp_var_get_and_del, arginfo_ssp_var_get_and_del)
...
static volatile int ssp_var_locks = 0;
