...
ALTER TABLE `fenxihui`.`ssp_user_setting` ADD COLUMN `mute` TINYINT(1) UNSIGNED NOT NULL COMMENT '静音' AFTER `sendkey_dateline`, ADD COLUMN `mute_dateline` INT(11) NOT NULL COMMENT '静音设置时间' AFTER `mute`;
