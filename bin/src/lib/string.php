...
class LibString {
	...
	function uuid () {
		...
		return chr(123) . substr($charid, 0, 8) . chr(45) . substr($charid, 8, 4) . chr(45) . substr($charid, 12, 4) . chr(45) . substr($charid, 16, 4) . chr(45) . substr($charid, 20, 12) . chr(125); // {26de6401-4629-8303-0611-a3f5d4d88a3e}
	}
	...
	function charset ( $str, $in = 'gbk', $out = "utf-8" ) {
